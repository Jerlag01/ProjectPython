...
log = logging.getLogger("projectpython.audio")
...
class Audio:
    ...
    async def cache_stats(self):
        """Reports info about the cache.
            ...
            - Minimum cache size. Automatically determined by number of servers ProjectPython is running on.
        """
    ...
    async def sing(self, ctx):
        """Makes ProjectPython sing one of her songs"""
...
def check_files():
    ...
    if not os.path.isfile(settings_path):
        ...
        try:
            ...
            # try to keep it from making the module load fail.
            dataIO.save_json(settings_path, default)
            current = dataIO.load_json(settings_path)
...
def setup(bot):
    ...
    if opus is False:
        ...
        raise RuntimeError(
            "You need to install ffmpeg and opus. See \"https://projectpython.flanderscraft.be"
            "/wiki/Requirements\"")
